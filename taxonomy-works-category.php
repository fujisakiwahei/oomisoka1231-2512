...
<section class="works">
    ...
    <div class="works__inner">
        ...
        <div class="works__category-list fade-up">
            <a href="<?php echo esc_url(home_url('/works')); ?>" class="works__category-item">All</a>
            <?php $args = array(
                'hide_empty' => 1,
                'exclude' => 1
            ); ?>
            ...
            <?php foreach ($categories as $category) : ?>
                <a
                    ...
                    class="works__category-item <?php if ($category->slug === $term_obj->slug) : ?>is-active<?php endif; ?>">
